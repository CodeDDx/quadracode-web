    ...
    <section id="founder" className="relative py-32">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            <div className="relative w-72 h-72 md:w-80 md:h-80 rounded-3xl overflow-hidden border border-white/10">
              <Image
          ...
          >
            ...
            <p className="text-lg text-[#7c5cfc] font-medium mb-6">
              {t.founder.role}
            </p>
            ...
            <div className="relative">
              <svg
                className="absolute -top-3 -left-2 w-8 h-8 text-[#7c5cfc]/20"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10H14.017zM0 21v-7.391c0-5.704 3.731-9.57 8.983-10.609L9.978 5.151c-2.432.917-3.995 3.638-3.995 5.849h4v10H0z" />
              </svg>
              <p className="text-xl md:text-2xl font-light text-[#8a8a9a] leading-relaxed italic pl-6">
            ...
            <div className="flex items-center gap-4 mt-8 justify-center lg:justify-start">
              <a href="#" className="w-11 h-11 rounded-xl bg-[#16161a] border border-white/5 flex items-center justify-center hover:border-[#7c5cfc]/30 hover:bg-[#7c5cfc]/10 transition-all duration-300 group">
        ...
        >
          <div className="p-8 md:p-12 rounded-3xl bg-[#16161a] border border-white/5 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-60 h-60 rounded-full bg-[#4d9fff]/[0.05] blur-[80px] pointer-events-none" />
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-[#4d9fff]/10 flex items-center justify-center">
